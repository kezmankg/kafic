...
namespace Server.Migrations
{
    ...
    [Migration("20250603125536_addDeskNoToBill")]
    partial class addDeskNoToBill
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Data.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Data.OrderPaidArticle", b =>
                {
                    b.HasOne("Server.Data.Article", "Article")
                        .WithMany("OrderPaidArticles")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Data.OrderPaid", "Order")
                        .WithMany("OrderArticles")
            ...
            modelBuilder.Entity("Server.Data.Article", b =>
                {
                    ...
                    b.Navigation("OrderPaidArticles");
                });
